...
|[**updateQueueSettings**](#updatequeuesettings) | **POST** /queues/{queueId}/settings | Update queue settings|
...
# **updateQueueSettings**
> QueueSettingsResponse updateQueueSettings()
...
const { status, data } = await apiInstance.updateQueueSettings(
    queueId,
    authId,
    maxHash
);
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
|**200** | Queue settings uptadte successfully |  -  |
|**400** | Invalid request parameters |  -  |
|**404** | Resource not found |  -  |
|**0** | Unexpected server error |  -  |
